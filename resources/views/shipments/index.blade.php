                ...
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
                    <form class="lg:pr-3" action="#" method="GET">
                        ...
                        <div class="relative mt-1 lg:w-64 xl:w-96">
                            <input type="text" name="id" id="shipment-search"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                placeholder="Search by Tracking Number (e.g. ST-1092)">
                        </div>
                    </form>
                </div>
                            ...
                            @forelse($shipments as $shipment)
                                <tr class="hover:bg-gray-100">
                                    <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-900">
                                        <div class="text-base font-semibold text-gray-900">{{ $shipment->tracking_number }}
                                        </div>
                                    </td>
